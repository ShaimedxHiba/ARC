...
def show_page():
    ...
    # Load both sheets from the Excel file
        watermills = pd.read_excel('chp.xlsx', sheet_name='Watermills')
        irrigation = pd.read_excel('chp.xlsx', sheet_name='Irrigation basins and canals')
        springs = pd.read_excel('chp.xlsx', sheet_name='Springs')
        terraces = pd.read_excel('chp.xlsx', sheet_name='Agricultural terraces')
        shelters = pd.read_excel('chp.xlsx', sheet_name='Nomadic shelters')
        granaries = pd.read_excel('chp.xlsx', sheet_name='Granaries')
    ...
    st.header('Actions done')
    st.markdown(
    """
    - **Agricultural terraces** in Ait Hssayn and Anamer have been repaired by **ReBuild**.
    - **Water canal** in Ait Hssayn and Tikiout  have been repaired by **ReBuild**.
    - **Pilot cultural restoration project** conducted with GDF and its partners Miyamoto, Turath, and Labina will begin soon.
    """,
    unsafe_allow_html=True
    )
